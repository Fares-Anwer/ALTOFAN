                    ...
                    <div class="demo-box m-t-20">
                        <div class="m-b-30">
                            <a href="add-subadmins.php">
                                <button id="addToTable" class="btn btn-custom waves-effect waves-light btn-md">Add <i
                            ...
                            <table class="table m-0  table-bordered" id="example">
                              ...
                              ?>
                                    <tr>
                                        ...
                                        <td><a href="edit-subadmin.php?said=<?php echo htmlentities($row['id']); ?>"
                                                class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                                            &nbsp;<a
                                                href="manage-subadmins.php?rid=<?php echo htmlentities($row['id']); ?>&&action=del"
