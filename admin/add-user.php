<?php
   ...
   $phone=$_POST['phone'];
   $userid=$_POST['userid'];
   $stmt=$con->prepare("insert into tbluser(name,email,password,phone,username,gender ) values('$name','$email','$password','$phone','$userid','$gender')");
   $stmt->execute();  
   if($stmt){
            ...
            <div class="content">
               <div class="container">
                ...
                <label for="gender">gender</label>
                                ...
                                <input class="form-control" id="phone" placeholder="Contact" type="text" name="phone" required="true">
                                 </div>
                                    <div class="form-group col-md-6">
                                    <label for="user:id">user:id</label>
                                <input class="form-control" id="user:id" placeholder="user:id" type="text" name="userid" required="true">
                                 </div>
