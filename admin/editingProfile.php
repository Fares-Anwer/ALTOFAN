...
<input class="form-control" id="inputPhone" type="tel" placeholder="Enter your phone number" value="+967 ">
</div>



<button class="btn btn-primary" type="button" style="margin: 5px;">Save changes</button>
</form>
</div>
</div>
</div>
