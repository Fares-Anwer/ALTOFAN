...
$password=md5($_POST['newpassword']);
                            $stmt=$con->prepare("select * from tbluser where  email='$email' and username='$username' "); 
                             ...
                             $ret= $stmt->rowCount();   
    if($ret>0){
        $stmt1=$con->prepare("update tbluser set password='$password'  where  email='$email' && username='$username' "); 
                              $stmt1->execute(); 
       if($stmt1)
   {
                                ...
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.php" class="text-success">
                                            <span><img src="admin/assets/images/logo.png" alt="" height="56"></span>
                                        </a>
                                    </h2>
