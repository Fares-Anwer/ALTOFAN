...
(1, 4, 'Fares', 'fares@gmail.com', 'hi', '2022-12-16 11:20:07', 1);
...
(1, 'aboutus', 'About AL-TOFAN TEAM', '<p style="text-align: justify; ">AL-TOFAN TEAM.
</p><p style="text-align: justify;"><b>
contact us at <a href="http:// alhamzawy72@gmail.com"> alhamzawy72@gmail.com</a>
</b></p><p style="text-align: justify;"><br></p><p style="text-align: justify;"><b>', '2021-06-29 18:30:00', '2023-01-25 18:00:11'),
(2, 'contactus', 'Contact Details', '<p><br></p><p><b>Address :&nbsp; </b>YEMEN SANAA</p><p><b>Phone Number : </b>+967776425225</p><p><b>Email -id : </b> AL-TOFAN</p>', '2024-01-5 18:30:00', '2022-12-13 16:50:24');
...
--
ALTER TABLE `tblcomments`
  ADD CONSTRAINT `pid` FOREIGN KEY (`postId`) REFERENCES `tblposts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `tblposts`
  ...
  ADD CONSTRAINT `subadmin` FOREIGN KEY (`postedBy`) REFERENCES `tbladmin` (`AdminUserName`) ON DELETE CASCADE ON UPDATE CASCADE ;

--
-- Constraints for table `tblsubcategory`
--
ALTER TABLE `tblsubcategory`
  ADD CONSTRAINT `catid` FOREIGN KEY (`CategoryId`) REFERENCES `tblcategory` (`id`) ON DELETE CASCADE ON UPDATE CASCADE ;
COMMIT;
